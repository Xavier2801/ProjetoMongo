...
import com.ruanxavier.workshopmongo.dto.AuthorDTO;
import com.ruanxavier.workshopmongo.dto.CommentDTO;
...
public class Instantiation implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        CommentDTO c1 = new CommentDTO("Boa viagem moça", sdf.parse("21/03/2018"), new AuthorDTO(alex));
